  ...
  <body>
    <div class="nav-wrapper"> 
      ...
      <div class="search-bar">
        <form action="main-process.php" method="get"> 
    ...
    <div class="main" >
      ...
      <div class="mid-sec">
      		...
      		<p style="font-size: 25px;font-weight: bolder;font-style:italic;">
      		<?php 
		...
		<?php        
			...
			if (!$conx) {
			  	die("connection faild:".mysqli_connect_error());
					...
					$searchedSTR = $_GET['search'];

				$sql = "SELECT * FROM usersgallery WHERE USERgallery='".$userName."';";
				...
				if (!mysqli_stmt_prepare($stmt,$sql)) {
					...
					while ($row = mysqli_fetch_assoc($result)) {
						if ($row['NAMEgallery'] == $searchedSTR) {
